...
public final class CreationCommandeForm {
    ...
    private static final String SESSION_CLIENTS        = "client";
    ...
    public Commande creerCommande( HttpServletRequest request, String chemin ) {
        ...
        client = (Client) session.getAttribute( SESSION_CLIENTS );
        commande.setClient( client );

        /*
         * String choixNouveauClient = getValeurChamp( request,
         * CHAMP_CHOIX_CLIENT ); if ( ANCIEN_CLIENT.equals( choixNouveauClient )
         * ) { /* Récupération de l'id du client choisi
         */
        /*
         * a String idAncienClient = getValeurChamp( request,
         * CHAMP_LISTE_CLIENTS ); Long id = null; try { id = Long.parseLong(
         * idAncienClient ); } catch ( NumberFormatException e ) { setErreur(
         * CHAMP_CHOIX_CLIENT,
         * "Client inconnu, merci d'utiliser le formulaire prévu à cet effet."
         * ); id = 0L; } /* Récupération de l'objet client correspondant dans la
         * session
         */
        /*
         * HttpSession session = request.getSession(); client = ( (Map<Long,
         * Client>) session.getAttribute( SESSION_CLIENTS ) ).get( id ); } else
         ...
         * de la map d'erreur créée par l'objet métier CreationClientForm dans
         ...
         * champs spécifiques à une commande.
         */
