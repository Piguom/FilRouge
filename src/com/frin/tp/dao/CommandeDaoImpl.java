...
public class CommandeDaoImpl implements CommandeDao {
    ...
    private static final String SQL_SELECT_PAR_ID = "SELECT id, id_client, date, montant, mode_paiement, statut_paiement, mode_livraison, statut_livraison FROM Commande WHERE id_client = ? ORDER BY id";
    ...
    public void creer( Commande commande ) throws DAOException {
        ...
        try {
            ...
            System.out.println( commande.getClient().getId() );
    ...
    /* Implémentation de la méthode définie dans l'interface ClientDao */
    public List<Commande> listerViaClient( long id ) throws DAOException {
        Connection connection = null;
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
        List<Commande> commandes = new ArrayList<Commande>();
