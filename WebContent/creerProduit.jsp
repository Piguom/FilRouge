...
<html>
    ...
    <body>
    	<h1 style="text-align:center">Création de produits</h1>
         <br>  
        <div>
            <form method="post" action="<c:url value="/creationProduit"/>" enctype="multipart/form-data">
                <fieldset style="margin-left:25%;width:50%;">
                    <legend>Informations produit</legend>
                    <c:import url="/inc/inc_produit_form.jsp" />
                </fieldset>  
                <fieldset style="margin-left:25%;width:50%;">
                <br><br>
