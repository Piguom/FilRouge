...
<html>
    ...
    <body>
    	<h1 style="text-align:center">Modification de votre compte client</h1>
         <br>  
        <div>
            <form method="post" action="<c:url value="/modificationClient"/>" enctype="multipart/form-data">
                <fieldset style="margin-left:25%;width:50%;">
                    <legend>Informations client</legend>
                    <c:import url="/inc/inc_modification_form.jsp" />
                </fieldset>  
                <fieldset style="margin-left:25%;width:50%;">
                <br><br>
                    ...
                    <c:if test="${!empty sessionScope.client}">
                		...
                		<a href="<c:url value="/accesRestreint.jsp"/>">
